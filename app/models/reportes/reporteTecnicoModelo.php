    ...
    public function generarReporteServicios($id_tecnico, $fecha_inicio, $fecha_fin)
    {
        try {
            ...
            $sql = "SELECT 
                ...
                c.nombre_cliente,
                p.nombre_punto,
                d.nombre_delegacion AS delegacion, -- << AQUÍ TRAEMOS LA DELEGACIÓN
                m.device_id,
                tm.nombre_completo AS tipo_mantenimiento
                    ...
                    LEFT JOIN delegacion d ON p.id_delegacion = d.id_delegacion -- << NUEVO JOIN (Ojo: verifica si el id_delegacion está en 'punto' o en 'cliente')
