...
<?php else: ?>
    ...
    <details class="group border-b border-gray-700">
        ...
        <div class="text-gray-400 mt-2 mb-2 pl-4 bg-gray-800 rounded-lg py-2">
            <a href="<?= BASE_URL ?>serviciosPdf" class="block py-2 px-4 hover:text-white hover:bg-gray-700 rounded flex items-center">
                <i class="fa-solid fa-file-pdf text-yellow-600 mr-2"></i> Servicios Pdf
            </a>
            <a href="<?= BASE_URL ?>rastreoTecnico" class="block py-2 px-4 hover:text-white hover:bg-gray-700 rounded flex items-center">
    ...
    <details class="group border-b border-gray-700">
        ...
        <div class="text-gray-400 mt-2 mb-2 pl-4 bg-gray-800 rounded-lg py-2">
            ...
            <a href="<?= BASE_URL ?>reporteDevolucion" class="block py-2 px-4 hover:text-white hover:bg-gray-700 rounded flex items-center">
                <i class="fa-solid fa-angles-left mr-2"></i> R. Devoluciones
            </a>
            <a href="<?= BASE_URL ?>asistencia" class="block py-2 px-4 hover:text-white hover:bg-gray-700 rounded flex items-center">
    ...
    <details class="group border-b border-gray-700">
        ...
        <div class="text-gray-400 mt-2 mb-2 pl-4 bg-gray-800 rounded-lg py-2 max-h-[40vh] overflow-y-auto">
            ...
            <a href="<?= BASE_URL ?>gestionDevolucion" class="block py-2 px-4 hover:text-white hover:bg-gray-700 rounded">Devoluciones de Repuestos</a>
            ...
            <a href="<?= BASE_URL ?>costosVer" class="block py-2 px-4 hover:text-white hover:bg-gray-700 rounded">Costos Motorizados</a>
            <a href="<?= BASE_URL ?>costosAdministrativosVer" class="block py-2 px-4 hover:text-white hover:bg-gray-700 rounded">Tipos Administrativos</a>
