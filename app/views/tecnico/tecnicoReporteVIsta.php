    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
        ...
        <div class="grid grid-cols-1 gap-4 text-sm">
            <div>
                ...
                <span
                    class="block font-bold text-gray-800 text-base leading-tight"><?= htmlspecialchars($orden['nombre_cliente']) ?></span>
                <span
                    class="block text-gray-600 font-medium mt-1"><?= htmlspecialchars($orden['nombre_punto']) ?></span>
                <?php if (!empty($orden['direccion'])): ?>
                    <span class="block text-gray-400 text-xs mt-1"><i class="fas fa-map-marker-alt"></i>
                        <?= htmlspecialchars($orden['direccion']) ?></span>
                <?php endif; ?>
            </div>
            <div class="bg-blue-50 p-3 rounded-lg border border-blue-100">
                <span class="block text-xs text-blue-400 font-bold uppercase mb-1">Máquina a intervenir</span>
                <span
                    class="block font-bold text-gray-800"><?= htmlspecialchars($orden['nombre_tipo_maquina']) ?></span>
                <span
                    class="block text-blue-600 font-mono text-xs mt-1 bg-white inline-block px-2 py-1 rounded border border-blue-200">
            ...
            <div>
                ...
                <select name="id_tipo_mantenimiento" class="w-full border-gray-300 rounded-lg select2-movil" required>
                    ...
                    <?php foreach ($tiposManto as $tm): ?>
                        <option value="<?= htmlspecialchars($tm['id_tipo_mantenimiento']) ?>"
                            <?= (isset($orden['id_tipo_mantenimiento']) && $orden['id_tipo_mantenimiento'] == $tm['id_tipo_mantenimiento']) ? 'selected' : '' ?>>
            ...
            <div class="grid grid-cols-2 gap-3 bg-gray-50 p-3 rounded-lg border border-gray-200">
                ...
                <div class="col-span-2 pt-2 border-t border-gray-200 flex justify-between items-center">
                    ...
                    <strong id="tiempo_total_display"
                        class="text-blue-600 bg-blue-100 px-3 py-1 rounded-full text-sm">00:00 hrs</strong>
            ...
            <div class="grid grid-cols-2 gap-3">
                <div>
                    ...
                    <select id="select_origen_modal"
                        class="w-full border border-gray-300 rounded-lg p-3 text-sm bg-gray-50 outline-none focus:border-blue-500">
