    ...
    <div class="min-h-[80vh] flex flex-col items-center justify-center px-4 py-8">
        <div class="w-full max-w-lg rounded-2xl shadow-xl overflow-hidden bg-white border border-gray-100">
            ...
            <div class="bg-gradient-to-br from-indigo-600 via-blue-600 to-indigo-700 p-6 text-center text-white relative">
                <div
                    class="inline-block bg-white/20 p-3.5 rounded-full mb-3 backdrop-blur-sm border border-white/20 shadow-inner">
                ...
                <div
                    class="mt-3 inline-flex items-center gap-1.5 px-3 py-1 bg-black/20 backdrop-blur-sm rounded-full text-xs text-indigo-100">
            ...
            <div class="p-6 space-y-3">
                ...
                <a href="<?= BASE_URL ?>tecnicoProgramacion"
                    ...
                    <div class="flex-1">
                        <h3 class="font-bold text-gray-800 text-sm group-hover:text-indigo-700 transition">Programación
                            Servicios</h3>
                ...
                <a href="<?= BASE_URL ?>cronometroHistorial"
                    ...
                    <div class="flex-1">
                        <h3 class="font-bold text-gray-800 text-sm group-hover:text-indigo-700 transition">Cronómetro Servicios Historial</h3>
                        <p class="text-xs text-gray-500">Ver y gestionar los tiempos de los servicios realizados</p>
                    </div>
                    <i
                        class="fas fa-chevron-right text-gray-300 group-hover:text-indigo-600 group-hover:translate-x-0.5 transition"></i>
                </a>
                ...
                <a href="<?= BASE_URL ?>ordenMovil"
                    ...
                    <div class="flex-1">
                        <h3 class="font-bold text-gray-800 text-sm group-hover:text-indigo-700 transition">Consultar
                            Historial</h3>
                ...
                <a href="<?= BASE_URL ?>parqueaderoHistorial"
                    ...
                    <div class="flex-1">
                        <h3 class="font-bold text-gray-800 text-sm group-hover:text-indigo-700 transition">Historial de
                            Parqueaderos</h3>
                ...
                <a href="<?= BASE_URL ?>horaExtraHistorial"
                    ...
                    <div class="flex-1">
                        <h3 class="font-bold text-gray-800 text-sm group-hover:text-indigo-700 transition">Historial Horas
                            Extra</h3>
                ...
                <div class="pt-4 text-center">
                    <a href="<?= BASE_URL ?>logout"
                        class="text-xs font-medium text-gray-400 hover:text-red-500 inline-flex items-center gap-1.5 transition">
    ...
    <div class="min-h-[80vh] flex flex-col items-center justify-center px-4 py-8">
        <div class="w-full max-w-md rounded-2xl shadow-2xl overflow-hidden bg-white">
            ...
            <div class="p-6 space-y-4">
                ...
                <div class="pt-4 text-center">
                    <a href="<?= BASE_URL ?>logout"
                        class="text-sm text-gray-400 hover:text-red-500 inline-flex items-center gap-1">
                        <i class="fas fa-sign-out-alt"></i> Cerrar sesión
                    </a>
                </div>
            </div>
...
<?php elseif ($nivel == 5): ?>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-10">
        ...
        <div class="rounded-2xl bg-gradient-to-r from-amber-700 via-orange-600 to-amber-600 p-6 shadow-xl text-white">
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    ...
                    <div
                        class="mt-3 flex items-center gap-2 text-xs bg-black/20 backdrop-blur-sm px-3 py-1.5 rounded-full w-fit">
        ...
        <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                ...
                <a href="<?= BASE_URL ?>ordenVer"
                    class="group bg-white rounded-xl shadow-sm hover:shadow-md p-5 transition-all hover:-translate-y-1 border border-gray-200 hover:border-amber-400 flex items-start gap-4">
                    ...
                    <div>
                        <h3 class="font-bold text-gray-800 text-base group-hover:text-amber-600 transition">Revisar
                            Servicios</h3>
                        <p class="text-xs text-gray-500 mt-1">Monitorear órdenes y estado de servicios asignados.</p>
                    </div>
                </a>

                <!-- Cronómetrar Servicios Técnicos -->
                <a href="<?= BASE_URL ?>cronometroAdmin"
                    class="group bg-white rounded-xl shadow-sm hover:shadow-md p-5 transition-all hover:-translate-y-1 border border-gray-200 hover:border-amber-400 flex items-start gap-4">
                    <div class="bg-amber-100 p-3.5 rounded-xl group-hover:bg-amber-600 transition shrink-0">
                        <i class="fa-solid fa-stopwatch text-xl text-amber-700 group-hover:text-white"></i>
                    </div>
                    <div>
                        <h3 class="font-bold text-gray-800 text-base group-hover:text-amber-600 transition">Cronómetrar Servicios Técnicos</h3>
                        <p class="text-xs text-gray-500 mt-1">Monitorear los tiempos de los servicios realizados.</p>
                    </div>
                </a>
                ...
                <a href="<?= BASE_URL ?>ordenDetalleBuscar"
                    ...
                    <div>
                        <h3 class="font-bold text-gray-800 text-base group-hover:text-amber-600 transition">Buscar Servicio
                        </h3>
                ...
                <a href="<?= BASE_URL ?>controlRemisionVer"
                    ...
                    <div>
                        <h3 class="font-bold text-gray-800 text-base group-hover:text-amber-600 transition">Administrar
                            Remisiones</h3>
        ...
        <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                ...
                <a href="<?= BASE_URL ?>repuestoVer"
                    class="group bg-white rounded-xl shadow-sm hover:shadow-md p-5 transition-all hover:-translate-y-1 border border-gray-200 hover:border-orange-400 flex items-start gap-4">
                    ...
                    <div>
                        <h3 class="font-bold text-gray-800 text-base group-hover:text-orange-600 transition">Ver Repuestos
                        </h3>
                ...
                <a href="<?= BASE_URL ?>inventarioTecnicoVer"
                    ...
                    <div>
                        <h3 class="font-bold text-gray-800 text-base group-hover:text-orange-600 transition">Inventario
                            Técnicos</h3>
        ...
        <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                ...
                <a href="<?= BASE_URL ?>reporteTecnico"
                    class="group bg-white rounded-xl shadow-sm hover:shadow-md p-5 transition-all hover:-translate-y-1 border border-gray-200 hover:border-emerald-400 flex items-start gap-4">
                    ...
                    <div>
                        <h3 class="font-bold text-gray-800 text-base group-hover:text-emerald-600 transition">Reporte de
                            Técnicos</h3>
                ...
                <a href="<?= BASE_URL ?>reporteEjecutivo"
                    ...
                    <div>
                        <h3 class="font-bold text-gray-800 text-base group-hover:text-emerald-600 transition">Reporte
                            Ejecutivo</h3>
                ...
                <a href="<?= BASE_URL ?>exportarExcel"
                    ...
                    <div>
                        <h3 class="font-bold text-gray-800 text-base group-hover:text-emerald-600 transition">Excel
                            Programación</h3>
                ...
                <a href="<?= BASE_URL ?>horaExtraAdmin"
                    ...
                    <div>
                        <h3 class="font-bold text-gray-800 text-base group-hover:text-emerald-600 transition">Reporte Horas
                            Extra</h3>
                        <p class="text-xs text-gray-500 mt-1">Administrar Horas Extra.</p>
                    </div>
                </a>
                ...
                <a href="<?= BASE_URL ?>parqueaderoAdmin"
                    ...
                    <div>
                        <h3 class="font-bold text-gray-800 text-base group-hover:text-emerald-600 transition">Reporte Parqueaderos</h3>
                        <p class="text-xs text-gray-500 mt-1">Administrar Parqueaderos.</p>
                    </div>
                </a>
        ...
        <div class="text-center pt-6 border-t border-gray-200">
            <a href="<?= BASE_URL ?>logout"
                class="inline-flex items-center gap-2 text-gray-500 hover:text-red-600 font-medium transition">
                <i class="fas fa-sign-out-alt"></i> Cerrar sesión
            </a>
        </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <?php else: ?>
            <div class="bg-yellow-50 border-l-4 border-yellow-400 p-4 mb-8 rounded">
                <p class="text-yellow-700"><i class="fas fa-info-circle mr-2"></i> No se pudieron cargar estadísticas. Verifica
                    las tablas.</p>
            </div>
        <?php endif; ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            <a href="<?= BASE_URL ?>ordenCrear"
                class="group relative bg-gradient-to-br from-blue-600 to-indigo-700 rounded-xl shadow-lg p-6 text-white overflow-hidden transform hover:-translate-y-1 transition duration-300">
            ...
            <a href="<?= BASE_URL ?>ordenVer"
                class="group bg-white rounded-xl shadow-md p-6 border border-gray-100 hover:border-blue-300 transition">
            ...
            <a href="<?= BASE_URL ?>clienteVer"
                class="group bg-white rounded-xl shadow-md p-6 border border-gray-100 hover:border-purple-300 transition">
                <div class="flex items-center gap-4">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 mb-12">
            ...
            <?php foreach ($reportes as $r): ?>
                <a href="<?= BASE_URL . $r['url'] ?>"
                    class="bg-white rounded-xl shadow p-4 hover:shadow-lg transition flex items-center gap-4 border-l-4 border-<?= $r['color'] ?>-500">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
            ...
            <?php foreach ($modulos as $m): ?>
                <a href="<?= BASE_URL . $m['url'] ?>"
                    class="flex flex-col items-center p-4 bg-gray-50 rounded-xl hover:bg-white transition border border-gray-200 text-center group">
                    <i
                        class="fas <?= $m['icon'] ?> text-<?= $m['color'] ?>-600 text-2xl mb-2 group-hover:scale-110 transition"></i>
