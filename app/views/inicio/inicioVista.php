<?php
// Centralizamos la variable de nivel de acceso para no repetir código
    ...
    <div class="min-h-[80vh] flex flex-col items-center justify-center px-4">
        <div class="bg-white w-full max-w-sm rounded-3xl shadow-2xl overflow-hidden border border-gray-100">
            <div class="bg-gradient-to-br from-indigo-600 to-blue-500 p-8 text-center text-white">
                ...
                <h1 class="text-2xl font-bold">¡Hola Técnico! 👋</h1>
            ...
            <div class="p-8 space-y-6">
                <p class="text-gray-500 text-center text-sm mb-4">¿Qué deseas hacer hoy?</p>
...
<?php elseif ($nivel == 4): ?>
    <div class="min-h-[80vh] flex flex-col items-center justify-center px-4">
        <div class="bg-white w-full max-w-sm rounded-3xl shadow-2xl overflow-hidden border border-gray-100">
            <div class="bg-gradient-to-br from-emerald-600 to-teal-500 p-8 text-center text-white">
                <div class="mb-4 inline-block bg-white/20 p-4 rounded-full backdrop-blur-sm">
                    <i class="fa-solid fa-person-military-pointing 2 fa-3x"></i>
                </div>
                <h1 class="text-2xl font-bold">¡Hola Funcionario de Prosegur!</h1>
            ...
            <div class="p-8 space-y-6">
                ...
                <a href="<?= BASE_URL ?>serviciosPdf"
                    class="group block w-full bg-white border-2 border-emerald-100 hover:border-emerald-500 rounded-2xl p-6 text-center shadow-sm hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
                    <div class="bg-emerald-50 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:bg-emerald-600 transition-colors duration-300">
                        <i class="fas fa-file-pdf text-2xl text-emerald-600 group-hover:text-white transition-colors"></i>
                    </div>
                    <h3 class="text-lg font-bold text-gray-800 group-hover:text-emerald-700">Consultar Historial</h3>
                    <p class="text-xs text-gray-400 mt-1">Revisar servicios realizados anteriormente Mediante Pdf.</p>
                </a>
