    ...
    <div class="bg-white p-6 sm:p-8 rounded-xl shadow-md border border-gray-100">
        ...
        <div class="mb-6 border-b pb-4">
            <h1 class="text-2xl sm:text-3xl font-bold text-gray-800">
                <i class="fas fa-edit text-yellow-500 mr-2"></i> Editar Repuesto
            </h1>
            <p class="text-gray-500 mt-1 ml-1">Modifica los detalles del ítem #<?= htmlspecialchars($id_repuesto) ?></p>
        </div>
        ...
        <form action="" method="POST" class="space-y-6">
            ...
            <div class="pt-6 border-t border-gray-100 flex justify-end space-x-4">
                <a href="<?= BASE_URL ?>repuestoVer" class="px-6 py-3 bg-white text-gray-700 font-semibold rounded-lg border border-gray-300 hover:bg-gray-50 transition-all">Cancelar</a>
