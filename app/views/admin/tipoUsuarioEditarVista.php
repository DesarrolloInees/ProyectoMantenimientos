...
<div class="w-full max-w-2xl mx-auto">
    <div class="bg-white p-6 rounded-xl shadow-md border border-gray-100">
        ...
        <div class="mb-6 border-b pb-4">
            ...
            <p class="text-gray-500 mt-1">Modificando: <strong><?= htmlspecialchars($datos['nombreTipoUsuario']) ?></strong></p>
        </div>
        ...
        <form action="" method="POST" class="space-y-6">
            <input type="hidden" name="idTipoUsuario" value="<?= $id ?>">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="text" name="nombreTipoUsuario" required
                        value="<?= htmlspecialchars($datos['nombreTipoUsuario']) ?>"
