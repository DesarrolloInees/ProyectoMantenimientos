    ...
    <div class="bg-white p-6 rounded-xl shadow-md border border-gray-100">
        ...
        <div class="flex justify-between items-center mb-6 border-b pb-4">
            <div>
                ...
                <p class="text-gray-500">Gestión de niveles de acceso.</p>
            </div>
            <a href="<?= BASE_URL ?>tipoUsuarioCrear" class="px-5 py-2.5 bg-indigo-600 text-white font-bold rounded-lg shadow hover:bg-indigo-700 transition flex items-center space-x-2">
        ...
        <?php if (!empty($data['tipos'])): ?>
            <div class="overflow-x-auto">
                <table id="rolesTable" class="w-full text-sm text-left">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        <?php foreach ($data['tipos'] as $t): ?>
                            <tr class="hover:bg-gray-50">
                                <td class="py-3 px-4 font-bold text-gray-600">#<?= $t['idTipoUsuario'] ?></td>
...
<div id="modalEliminar" class="fixed inset-0 z-50 hidden flex items-center justify-center bg-black bg-opacity-50">
    <div class="bg-white rounded-lg p-6 w-full max-w-sm shadow-xl">
        ...
        <p class="text-sm text-gray-500 mb-4">¿Seguro? Si hay usuarios con este rol, no se podrá borrar.</p>
