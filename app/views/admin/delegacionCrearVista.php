    ...
    <div class="bg-white p-6 rounded-xl shadow-md border border-gray-100">
        ...
        <div class="mb-6 border-b pb-4">
            <h1 class="text-2xl font-bold text-gray-800">
                <i class="fas fa-map-marker-alt text-indigo-600 mr-2"></i> Nueva Delegación
            </h1>
            <p class="text-gray-500 mt-1">Registra una zona geográfica o administrativa.</p>
        </div>
        ...
        <form action="<?= BASE_URL ?>delegacionCrear" method="POST" class="space-y-6">
            <div>
                <label class="block text-sm font-bold text-gray-700 mb-1">Nombre de la Delegación <span class="text-red-500">*</span></label>
                <div class="relative">
