    ...
    <div class="bg-white p-6 rounded-xl shadow-md border border-gray-100">
        ...
        <div class="mb-6 border-b pb-4">
            <h1 class="text-2xl font-bold text-gray-800">
                <i class="fas fa-traffic-light text-indigo-600 mr-2"></i> Nuevo Estado
            </h1>
            <p class="text-gray-500 mt-1">Define una condición para las máquinas (Ej: Operativa, Dañada).</p>
        </div>
        ...
        <form action="<?= BASE_URL ?>estadoMaquinaCrear" method="POST" class="space-y-6">
            <div>
                <label class="block text-sm font-bold text-gray-700 mb-1">Nombre del Estado <span class="text-red-500">*</span></label>
                <div class="relative">
            ...
            <div class="pt-6 border-t border-gray-100 flex justify-end space-x-4">
                <a href="<?= BASE_URL ?>estadoMaquinaVer" class="px-6 py-3 bg-white text-gray-700 font-semibold rounded-lg border border-gray-300 hover:bg-gray-50">Cancelar</a>
