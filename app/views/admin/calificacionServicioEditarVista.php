    ...
    <div class="bg-white p-6 rounded-xl shadow-md border border-gray-100">
        ...
        <div class="mb-6 border-b pb-4">
            <h1 class="text-2xl font-bold text-gray-800">
                <i class="fas fa-edit text-yellow-500 mr-2"></i> Editar Calificación
            </h1>
            <p class="text-gray-500 mt-1">Modificando: <strong><?= htmlspecialchars($datos['nombre_calificacion']) ?></strong></p>
        </div>
        ...
        <form action="" method="POST" class="space-y-6">
            <input type="hidden" name="id_calificacion" value="<?= $id ?>">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="text" name="nombre_calificacion" required
                        value="<?= htmlspecialchars($datos['nombre_calificacion']) ?>"
