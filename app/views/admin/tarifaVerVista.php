...
<style>
    ...
    #tarifasTable tbody tr { background-color: white !important; }
    #tarifasTable tbody tr:hover { background-color: #f9fafb !important; }
...
<div class="w-full max-w-7xl mx-auto">
    <div class="bg-white p-6 rounded-xl shadow-md border border-gray-100">
        ...
        <?php else: ?>
            <div class="text-center p-8 bg-gray-50 rounded-lg"><p class="text-gray-500">No hay tarifas registradas.</p></div>
        <?php endif; ?>
    </div>
</div>
...
<script>
    $(document).ready(function() { $('#tarifasTable').DataTable({ language: { url: '//cdn.datatables.net/plug-ins/1.13.4/i18n/es-ES.json' } }); });
    function abrirModal(id) { document.getElementById('btnConfirmar').href = "<?= BASE_URL ?>tarifaEliminar/" + id; document.getElementById('modalEliminar').classList.remove('hidden'); }
