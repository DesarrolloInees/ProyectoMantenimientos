    ...
    <div class="bg-white p-6 rounded-xl shadow-md border border-gray-100">
        ...
        <div class="mb-6 border-b pb-4">
            <h1 class="text-2xl font-bold text-gray-800">
                <i class="fas fa-edit text-yellow-500 mr-2"></i> Editar Tipo
            </h1>
            <p class="text-gray-500 mt-1">Modificando: <strong><?= htmlspecialchars($datos['nombre_tipo_maquina']) ?></strong></p>
        </div>
        ...
        <form action="" method="POST" class="space-y-6">
            <input type="hidden" name="id_tipo_maquina" value="<?= $id ?>">

            <div>
                <label class="block text-sm font-bold text-gray-700 mb-1">Nombre del Tipo <span class="text-red-500">*</span></label>
                <div class="relative">
                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none"><i class="fas fa-robot text-gray-400"></i></div>
                    <input type="text" name="nombre_tipo_maquina" required
                        value="<?= htmlspecialchars($datos['nombre_tipo_maquina']) ?>"
            ...
            <div class="pt-6 border-t border-gray-100 flex justify-end space-x-4">
                <a href="<?= BASE_URL ?>tipoMaquinaVer" class="px-6 py-3 bg-white text-gray-700 font-semibold rounded-lg border border-gray-300 hover:bg-gray-50">Cancelar</a>
