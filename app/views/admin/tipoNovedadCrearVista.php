    ...
    <div class="bg-white p-6 rounded-xl shadow-md border border-gray-100">
        ...
        <div class="mb-6 border-b pb-4">
            <h1 class="text-2xl font-bold text-gray-800">
                <i class="fas fa-tags text-indigo-600 mr-2"></i> Nuevo Tipo de Novedad
            </h1>
            <p class="text-gray-500 mt-1">Registra una nueva clasificación para las novedades.</p>
        </div>
        ...
        <form action="<?= BASE_URL ?>tipoNovedadCrear" method="POST" class="space-y-6">
            <div>
