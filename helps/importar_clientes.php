...
<head>
    ...
    <style>
        ...
        .container { background: white; padding: 30px; border-radius: 10px; max-width: 800px; margin: auto; box-shadow: 0 4px 10px rgba(0,0,0,0.1); }
        h1 { text-align: center; color: #333; }
        .upload-area { border: 2px dashed #007bff; padding: 40px; text-align: center; border-radius: 10px; background: #f8faff; margin: 20px 0; }
        .btn { background: #007bff; color: white; border: none; padding: 10px 20px; border-radius: 5px; cursor: pointer; font-size: 16px; }
        .btn-success { background: #28a745; width: 100%; padding: 15px; font-size: 18px; margin-top: 20px; }
        .conflicto-row { border-bottom: 1px solid #eee; padding: 15px 0; display: flex; justify-content: space-between; align-items: center; }
        .exito { background: #d4edda; color: #155724; padding: 15px; border-radius: 5px; text-align: center; }
        .error { background: #f8d7da; color: #721c24; padding: 15px; border-radius: 5px; text-align: center; }
        .info { background: #cce5ff; color: #004085; padding: 15px; border-radius: 5px; text-align: center; }
